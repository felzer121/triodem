              ...
              <div className="container">
                <div className="columns-2 flex items-center">
                  <div className="flex flex-col gap-6 w-full">
                      <h2 className="text-5xl max-w-96"><span className={introCond.className}>Выйдите на новый уровень.</span></h2>
                      ...
                      <div className="flex gap-3 flex-col">
                        <div className="flex gap-6 max-w-sm">
                          ...
                          <Link href={'#aboutDevelopment'} className="shadow-[0_0_0_3px_#0A0A0A_inset] px-6 py-3 bg-zinc-950 border border-zinc-950 dark:border-zinc-700 dark:text-white text-black text-base rounded-lg font-semibold transform hover:-translate-y-1 transition duration-400">
                            Узнать Больше
                          </Link>
                        </div>
